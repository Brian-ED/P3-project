...
public final class SurveyMorningRow implements Survey {
    ...
    @Embedded private RollAnswer                     internelAnswer2 = new RollAnswer                    (); @Transient final private FineRollQuestion                     answer2 = new FineRollQuestion                    ("I går gik jeg i seng klokken:"                                                                                                , internelAnswer2); public FineRollQuestion                     getAnswer2() {return answer2;}
    ...
    @Embedded private DurationAnswer                 internelAnswer4 = new DurationAnswer                (); @Transient final private DurationQuestion                 answer4 = new DurationQuestion                ("Efter jeg slukkede lyset, sov jeg ca. efter:"                                                                                 , internelAnswer4); public DurationQuestion                 getAnswer4() {return answer4;}
    ...
    @Embedded private DurationAnswer                 internelAnswer6 = new DurationAnswer                (); @Transient final private DurationQuestion                 answer6 = new DurationQuestion                ("Jeg var sammenlagt vågen i cirka x minutter i løbet af natten"                                                                , internelAnswer6); public DurationQuestion                 getAnswer6() {return answer6;}
